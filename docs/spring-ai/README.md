...
| [SPRING_AI_STAGE_6.md](SPRING_AI_STAGE_6.md) | **Model Context Protocol (MCP)** | 6 demos: MCP servers (STDIO, Streamable HTTP), MCP clients, dynamic tool registration (McpSyncServer.addTool), full MCP capabilities (@McpResource, @McpPrompt, @McpComplete) — runnable from the dashboard at `/dashboard/stage/6` |
