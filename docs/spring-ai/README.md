...
| [SPRING_AI_STAGE_4.md](SPRING_AI_STAGE_4.md) | **AI Patterns** | 7 demos: stuff-the-prompt, manual RAG (search → format → prompt), advisor-based RAG (QuestionAnswerAdvisor), stateless vs stateful chat, chat memory (MessageChatMemoryAdvisor, MessageWindowChatMemory), advisor architecture |
