...
cmd_check() {
    ...
    echo -e "Tech Stack: Spring Boot 4.0.6 | Spring AI 2.0.0-M8 | Java 25"
    echo "──────────────────────────────────────────────"
...
cmd_help() {
    ...
    echo -e "Boot 4.0.6 | AI 2.0.0-M8 | Java 25"
    echo ""
...
draw_menu() {
    ...
    echo -e "${BOLD}${CYAN}│${NC}  Boot 4.0.6 | AI 2.0.0-M8 | Java 25                      ${BOLD}${CYAN}│${NC}"
    echo -e "${BOLD}${CYAN}├──────────────────────────────────────────────────────────┘${NC}"
